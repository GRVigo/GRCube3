...
namespace grcube3
{
	...
	public:
        ...
        uint GetLengthSolve() const
        {
            return GetLengthCrossSolve() +
                   ...
                   GetLengthOLLTurn() + GetLengthOLLSolve() +
                   GetLengthAUFSolve() +
                   GetLengthPLLTurn() + GetLengthPLLSolve();
        }
        ...
        double GetFullTime() const { return CrossTime + F2LTime + OLLTime + PLLTime; }
	...
	private:
		...
		// Cubes
		Cube CubeBase, CubeCross, CubeF2L, CubeOLL, CubeFinal; // No inspection turn

        // Times
        double CrossTime, F2LTime, OLLTime, PLLTime;
